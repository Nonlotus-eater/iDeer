...
def main() -> int:
    ...
    env_map: dict[str, str] = {
        ...
        "REPORT_MIN_SCORE": read_env("IDEER_REPORT_MIN_SCORE", "7.0"),
        "REPORT_MAX_ITEMS": read_env("IDEER_REPORT_MAX_ITEMS", "12"),
        "REPORT_THEME_COUNT": read_env("IDEER_REPORT_THEME_COUNT", "4"),
        "REPORT_PREDICTION_COUNT": read_env("IDEER_REPORT_PREDICTION_COUNT", "0"),
        "REPORT_IDEA_COUNT": read_env("IDEER_REPORT_IDEA_COUNT", "0"),
        ...
        "OPENREVIEW_VENUES": read_env("IDEER_OPENREVIEW_VENUES", ""),
        "OPENREVIEW_INVITATIONS": read_env("IDEER_OPENREVIEW_INVITATIONS", ""),
        "OPENREVIEW_QUERIES": read_env("IDEER_OPENREVIEW_QUERIES", ""),
        "OPENREVIEW_MAX_RESULTS": read_env("IDEER_OPENREVIEW_MAX_RESULTS", "50"),
        "OPENREVIEW_MAX_PAPERS": read_env("IDEER_OPENREVIEW_MAX_PAPERS", "20"),
        "OPENREVIEW_DAYS": read_env("IDEER_OPENREVIEW_DAYS", "0"),
        "OPENREVIEW_API_VERSIONS": read_env("IDEER_OPENREVIEW_API_VERSIONS", "2|1"),
